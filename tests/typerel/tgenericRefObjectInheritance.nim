...
nimout: '''tgenericRefObjectInheritance.nim(21, 6) Error: type mismatch: got <Thin[system.int]>
but expected one of:
...
expression: test tn'''
description: "generic object descended from generic ref object sigmatch bug ; #7600"
"""
