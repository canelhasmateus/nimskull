...
foo2
'''
description: "type alias for generic typeclass doesn't work #4668; This should create an alias for the typeclass FooObj. Incidentally both x is FooObj and x is Foo1 return true while x is Foo2 gives false. ; And interestingly, if I instead set type
Foo2 = Foo1 then it works."
tags: [ generics, type alias, typeclasses, error_runtime]
"""
