discard """
  ...
  line: 28
  description: "I think it has to do with the fact that type inference does not (unfortunately) perform backtracking, and Nim is not able to figure out T from the first parameter (it needs the vector to resolve T)."
  tags: [should_error , generics, static , error_compile]
"""
